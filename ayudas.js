//***************
//la forma de implementar  una peticion http por el framworck o libreria Express
/*
...
de las vistas de HTML, uso del motores de 'templates', y gestión de las 
configuraciones de las aplicaciones  que controlan la aplicación 
...
Las líneas que siguen en el código (las tres líneas que comienzan con 
    ...
    eciba una petición  HTTP GET con una dirección ('/') relativa al 
...
en un navegador, y ver como el servidor de este ejemplo devuelve 
